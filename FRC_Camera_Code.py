    ...
    def process(self, source0):
        ...
        for c in self.filter_contours_output:
            ...
            cv2.putText(source0, str(cY), (cX - 40, cY - 40),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
        return imagem_teste, self.hsv_threshold_output, cY
...
def main():
    ...
    while True:
        ...
        print(processImage.hsv_threshold_hue)
        print(processImage.hsv_threshold_saturation)
        print(processImage.hsv_threshold_value)
